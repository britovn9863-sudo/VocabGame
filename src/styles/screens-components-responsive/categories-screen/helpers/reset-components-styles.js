...
function resetComponentsPositions(components) {
  ...
  const CARDS_CONTAINER_POSITIONS = categoriesScreenPositions.cardsContainer.desktop;
  ...
  if (CARDS_CONTAINER_POSITIONS && components.cardsContainer) {
    components.cardsContainer.position.set(
      CARDS_CONTAINER_POSITIONS.x,
      CARDS_CONTAINER_POSITIONS.y
    );
  }
