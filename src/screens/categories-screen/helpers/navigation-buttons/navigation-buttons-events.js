...
export function updateDisplayedContent(categoriesScreen) {
  ...
  // Recalcula o hover das setas depois da atualização da tela.
  // Isso permite que a seta continue em hover mesmo
  // quando o mouse não foi movimentado.
  queueMicrotask(() => {
    categoriesScreen.previousButton.interaction.refreshHover();
    categoriesScreen.nextButton.interaction.refreshHover();
  });
}