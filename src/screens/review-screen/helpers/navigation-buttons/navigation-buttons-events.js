...
function changeCurrentIndex(step, reviewScreen) {
  ...
  // Mantém o estado visual correto quando o conteúdo muda sem mover o mouse.
  queueMicrotask(() => {
    reviewScreen.previousButton.interaction.refreshHover();
    reviewScreen.nextButton.interaction.refreshHover();
  });
}
